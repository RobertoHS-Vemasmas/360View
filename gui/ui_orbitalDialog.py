from Visor360.gui import resources_rc
...
class Ui_orbitalDialog(object):
    def setupUi(self, orbitalDialog):
        ...
        sizePolicy.setHeightForWidth(
            orbitalDialog.sizePolicy().hasHeightForWidth())
        orbitalDialog.setSizePolicy(sizePolicy)
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap(":/Visor360/images/icon.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap(":/Visor360/images/Previous_Arrow.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(
            QtGui.QPixmap(":/Visor360/images/Next_Arrow.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        self.btn_fullscreen.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btn_fullscreen.setText("")
        icon3 = QtGui.QIcon(":Visor360/images/full_screen.png")
        icon3.addPixmap(QtGui.QPixmap(), QtGui.QIcon.Normal, QtGui.QIcon.On,)
        self.btn_fullscreen.setIcon(icon3)
        self.btn_fullscreen.setCheckable(False)
    ...
    def retranslateUi(self, orbitalDialog):
        ...
        orbitalDialog.setWindowTitle(
            _translate("orbitalDialog", "Visor de imagenes 360°")
        )